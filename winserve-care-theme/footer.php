    ...
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <p class="footer-address">
          Unit 52, Pure Offices<br>
          Turnberry Park Road, Morley<br>
          Leeds, LS27 7LE
        </p>
      ...
      <div class="footer-col">
        <h4>Our Services</h4>
        <ul>
          <li><a href="<?php echo esc_url( home_url( '/services' ) ); ?>#domiciliary">Domiciliary Care</a></li>
          <li><a href="<?php echo esc_url( home_url( '/services' ) ); ?>#supported-living">Supported Living</a></li>
          <li><a href="<?php echo esc_url( home_url( '/services' ) ); ?>#complex-care">Complex Care</a></li>
          <li><a href="<?php echo esc_url( home_url( '/staff-portal' ) ); ?>">Staff Portal</a></li>
      ...
      <div class="footer-col">
        ...
        <div class="footer-accreditations">
          <span class="accred-badge">Living Wage Employer</span>
          <span class="accred-badge">CHAS</span>
          <span class="accred-badge">Armed Forces Covenant</span>
          <span class="accred-badge">CQC Good</span>
        </div>
      </div>
